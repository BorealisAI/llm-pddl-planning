...
The environment consists of a grid of positions and five heights, numbered 0 through 4. The robot can move at the same height, move up one height, or move down one height. It can also place or remove a block at a neighboring position, or create or destroy a block at the depot. A block's height increases by one when placed and decreases by one when removed.
...
- The height at pos-2-0 needs to be 4.
- The height at pos-3-0 needs to be 3.
- The height at pos-3-1 needs to be 3.
- The height at pos-3-2 needs to be 4.
