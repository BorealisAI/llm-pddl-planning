...
Initially:
- All positions on the 4x3 grid have a height of 0.
...
- There are successor relationships between the numbers n0, n1, n2, and n3.

Your goal is to achieve the following configuration:
- The height at pos-0-0 needs to be 2.
- The height at pos-0-2 needs to be 2.
- The height at pos-1-0 needs to be 3.
- The height at pos-1-2 needs to be 3.
- The height at pos-2-2 needs to be 2.
- The height at pos-3-1 needs to be 2.
